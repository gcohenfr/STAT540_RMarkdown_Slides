...
<br>
H<sub>0</sub>: the expression of gene A is the same in both conditions.

### <center><font color="red">  Is there **enough** evidence in the data to reject H<sub>0</sub>? </font>
...
### Is this convincing evidence that the population parameters $\mu_Y \neq \mu_Z$?
...
.pull-left[
### What can we use to help us interpret the size of the mean difference?
]
.pull-right[
### $$\frac{\bar{Y}-\bar{Z}}{??}$$
]
...
.pull-right[
<small> $$\text{e.g., } S_Y^2=\frac{1}{n_Y}\sum_{i=1}^{n_Y}(Y_i-\bar{Y})^2=1.224$$
]
---
class: middle
