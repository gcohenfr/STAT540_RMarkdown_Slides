...
subtitle: "<font color=red> Lecture 7 -- Linear Models</font> <br style=line-height:2> Keegan Korthauer"
date: "2020/01/22 <br><font size=5> Slides by: Gabriela Cohen Freue with contributions from Jenny Bryan </font>"
output:
...
<small> The $x_{DD,ijk}$ are dummy variables (see [math handout](math_handout.html))
---
# More general!
