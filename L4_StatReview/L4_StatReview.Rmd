...
<div class = "blue">
<b>Random Variable (RV):</b> A variable whose value results from the measurement of a quantity that is subject to variation (i.e. the <i>outcome</i> an experiment)
</div>
...
<div class = "blue">
<b>Probability:</b> A number assigned to an outcome that describes the extent to which it is likely to occur
</div>

  - Must satisfy certain rules (e.g. be between 0 and 1)
  - Represents the (long-term) *frequency* of an outcome
  
--

<div class = "blue">
<b>Probability distribution:</b> A mathematical function that maps outcomes to probabilities
</div>  
...
.pull-left[
* **Outcome of interest (RV)**: number of heads

* **Possible outcomes**: sample space

* **Probability distribution**: mapping between each possible outcome and a probability
...
* Each realization of the RV corresponds to an event in the sample space

* we can assign a probability to each realization 
