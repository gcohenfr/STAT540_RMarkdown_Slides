...
Let's make a change of notation to be consistent with conventions used in linear regression
<br> <br>
$$Y \sim G; \; E[Y] = \mu_Y$$
 **<center>↓</center>**
...
<br>
And we can use a subindex $j$ to distinguish the groups, i.e., 

$$Y_j = \mu_j + \varepsilon_j; \; \varepsilon_j \sim G_j; \; E[\varepsilon_j] = 0$$

where $j = \textrm{\{wt, NrlKO}\}$ or $j=\textrm{\{1, 2}\}$.
<br>
...
.pull-left[
### <center> Group 1 (WT)
$$Y_1 = \mu_1 + \varepsilon_1;\; \;  \varepsilon_1 \sim G_1;\; \;  E[\varepsilon_1] = 0;$$
]
.pull-right[
### <center> Group 2 (NrlKO)
$$Y_2 = \mu_2 + \varepsilon_2; \; \; \varepsilon_2 \sim G_2; \; \; E[\varepsilon_2] = 0;$$
]
> We may assume a common distribution $G$ for all groups
...
> $Y_{ij}: \textrm{gene expression of gene A for the ith observation in condition j}$
