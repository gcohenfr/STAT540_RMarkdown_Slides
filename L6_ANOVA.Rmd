...
<font size=5> Which is the same as $\; \rightarrow \; Y_{ij} = \theta + \tau_j + \varepsilon_{ij}, \; \tau_1=0$
---
class: middle

## Difference of means: the "treatment effect"
<font size=5> $Y_{ij} = \theta + \tau_j + \varepsilon_{ij}, \; \tau_1=0, \; E[\varepsilon_{ij}]=0$
> Note that $E[Y_{i1}] = \theta + \tau_j$
...
<font color = red> $Y:$ </font> a column vector containing the responses, one element per experimental unit
