...
---
class: middle
### The <font color="red">sample</font> means: $\hat\mu_{E16}, \; \hat\mu_{P2}, \; \hat\mu_{P6}, \; \hat\mu_{P10}, \; \hat\mu_{4weeks}$
``` {r}
...
<big>
- the *t*-test in linear regression allows us to test simple hypotheses:
$$H_0 : \tau_i = 0$$
$$H_A : \tau_j \neq 0$$
