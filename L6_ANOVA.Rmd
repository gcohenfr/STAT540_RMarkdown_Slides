...
subtitle: "<font color=red> Lecture 6 -- ANOVA and Linear Models</font> <br style=line-height:2><br> Gabriela Cohen Freue"
...
**↓**
$$Y_j = \mu_j + \varepsilon_j; \varepsilon_j ~ F_j; E[\varepsilon_j] = 0; j = \textrm{\{wt, NrlKO}\} \rightarrow \textrm{\{1, 2}\}$$
<br>
where $Y_j$ is the **response variable**. For $\varepsilon_j ~ F_j$, we may even assume a common distribution $F$ for all groups, equal variances, etc.
---
class: middle
...
---
class: middle
<font size = 6> $$H_0 : \mu_1 = \mu_2$$ </font>
.pull-left[
```
data: gExp by gType
